            ...
            for (var i=0; i< this.pickResults.length; i++) {
                ...
                if (obj)
                {
                  var customId = this.pickResults[i][1];
                    if(!this.isGameModeSelected)
                    ...
                    else if(this.playing && !this.needMoverToRemove && (this.gameMode == 0 || (this.gameMode == 1 && this.player == 0))){
                      ...
                      console.log("here");
                      console.log(this.pickIDs[customId - 1] + "    " + this.players[this.player]);
...
XMLscene.prototype.handleReply = function(data){
  ...
  if(responseArr[0] == "0"){
    ...
    //TODO add text to select mover to remove
